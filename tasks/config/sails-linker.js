...
module.exports = function(grunt) {
	...
	grunt.config.set('sails-linker', {
		devJs: {
			...
			files: {
				'.tmp/public/**/*.html': require('../pipeline').jsCustomFilesToInject,
				'views/**/*.html': require('../pipeline').jsCustomFilesToInject,
				'views/**/*.ejs': require('../pipeline').jsCustomFilesToInject
			}
		},
